...
src/common/%.o: ../src/common/%.cpp
	...
	/usr/local/cuda-7.5/bin/nvcc -I/usr/local/include/opencv -I/usr/local/include/cuda-7.5/targets/x86_64-linux/include -G -g -O0 -std=c++11 -gencode arch=compute_52,code=sm_52  -odir "src/common" -M -o "$(@:%.o=%.d)" "$<"
