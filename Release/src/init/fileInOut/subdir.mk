...
src/init/fileInOut/%.o: ../src/init/fileInOut/%.cpp
	...
	/usr/local/cuda-7.5/bin/nvcc -I/usr/local/include/ -I/usr/local/cuda-7.5/targets/x86_64-linux/include -lineinfo -O3 --use_fast_math -std=c++11 -gencode arch=compute_52,code=sm_52  -odir "src/init/fileInOut" -M -o "$(@:%.o=%.d)" "$<"
