...
src/init/fileInOut/%.o: ../src/init/fileInOut/%.cpp
	...
	/usr/local/cuda-6.5/bin/nvcc -I/usr/local/include/opencv -O3 -gencode arch=compute_35,code=sm_35  -odir "src/init/fileInOut" -M -o "$(@:%.o=%.d)" "$<"
	/usr/local/cuda-6.5/bin/nvcc -I/usr/local/include/opencv -O3 --compile  -x c++ -o  "$@" "$<"
